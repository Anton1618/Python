...
from lesson_functions.calculator_with_lambda import calculator
...
class Calculator_With_Lambda_Test(TestCase):
    def test_plus(self):
        ...
        # self.assertEqual(calculator('2+2'), None) # Ложный тест
        self.assertEqual(calculator('2+2'), 4) # Истинный тест
