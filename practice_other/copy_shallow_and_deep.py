...
if __name__ == '__main__':
    ...
    print('Изменение мутабельного элемента в исходном объекте: collection[3][0] = 1000\n' \
    ...
    print('Изменение не мутабельного элемента в любом объекте-копии: collection[1] = 2000\n' \
        'Изменения приведут к получению нового элемента конкретно в этом объекте, что не повлияет на другие объекты')
    list_b1[1] = 2000
    print(
        f'original: {list_a}',
    ...
    print('Изменение мутабельного элемента в любом объекте-копии: collection[3][1] = 2000\n' \
        'Изменения приведут к преобразованию изначального элемента во всех объектах, которые ссылаются на данный элемент')
    list_b1[3][1] = 2000
    print(
        f'original: {list_a}',
