'''Представлено два объекта класса warrior, которые применяются в объекте класса Battle
 Объекты учавствуют в методе battle, представляя сражение между ними
 Благодаря параметру self, метод объекта make_kick определяет к какому именно объекту станут применены инструкции
 Без параметра self, вызванный метод, станет выполнять инструкцию вычитания здоровья из объета, который её вызвал,
 ...
 Цикл повторяется до тех пор, пока здоровье одного из двух воинов не закончится, опустившись до 0'''
