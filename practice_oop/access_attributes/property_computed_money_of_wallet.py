'''Класс Wallet, реализует аналог денежного кошелька

Предоставляет
- информацию о валюте и остатке средств на счете
- осуществляет присвоение нового значения для атрибута долларов или центов, не изменяя другое значение
