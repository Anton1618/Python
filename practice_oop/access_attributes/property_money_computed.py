'''Класс Money преобразующий аргументы долларов и сентов в общее количество центов, атрибут - total_cents
...
Прибавляет полученное значение в атрбут total_cents,
