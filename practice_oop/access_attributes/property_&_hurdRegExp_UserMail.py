...
- Декорируемое свойство password имеет:
    ...
    Это управляемое свойство применяется для получения самого пароля, а также применяется в других методах как проверка,
    выполняя роль аутентификации пользователя
