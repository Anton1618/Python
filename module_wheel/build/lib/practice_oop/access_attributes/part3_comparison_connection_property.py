'''Сравнение способов обращения к атрибутам.

Логика методов опускается, демонстрируется только способ обращений:
- Прямое обращение
- Обращение через пользовательские методы
- Обращение через property-методы
'''
